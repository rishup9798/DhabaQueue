...
export default function HeroScrollVideoReveal({
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      const headingWords = headingRef.current?.querySelectorAll(
        ".hero-word"
      );
      ...
      gsap.fromTo(
        ...
        },
        {
          ...
          ease: "power3.out",
          scrollTrigger: {
            trigger: heroRef.current?.querySelector(
              ".hero-bottom"
            ),
            start: "top 70%",
            toggleActions: "play none none reverse",
  ...
  return (
    <div
      ref={heroRef}
      className={`w-full overflow-hidden bg-[#09090b] text-white ${className}`}
    >
      {/* HERO INTRO */}
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 text-center">
        ...
        <div className="relative z-10 max-w-5xl">
          ...
          <p className="mx-auto mt-8 max-w-2xl text-base leading-7 text-white/45 md:text-lg">
            Stop making your customers wait without knowing
            what comes next.
          </p>
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-3">
            <a
              href="/dashboard"
              className="rounded-full bg-[#e3a008] px-7 py-3.5 text-sm font-bold text-black shadow-[0_0_40px_rgba(227,160,8,0.2)] transition duration-300 hover:scale-105 hover:bg-[#f5b51b]"
            >
              Open Dashboard
            </a>
          ...
          <div className="mt-16 text-xs uppercase tracking-[0.3em] text-white/25">
            Scroll to explore
          </div>
      ...
      >
        <div className="mx-auto w-full max-w-6xl text-center">
          ...
          <p className="mb-5 text-sm font-semibold uppercase tracking-[0.3em] text-[#e3a008]">
            One system. Everything connected.
          </p>

          <h2
            ref={headingRef}
            className="mx-auto max-w-5xl text-[clamp(2.5rem,6vw,6.5rem)] font-black leading-[0.95] tracking-[-0.05em]"
            style={{ perspective: "800px" }}
          >
            {renderWords(
              headingText ||
                "Turn restaurant queues into seamless experiences."
            )}
          </h2>
          ...
          <div className="mx-auto mt-12 flex max-w-5xl flex-wrap justify-center gap-3">
            {tags.map((tag, index) => (
              <div
                ...
                className="rounded-full px-5 py-3 text-sm font-bold shadow-lg sm:px-7 sm:py-3.5 sm:text-base"
                style={{
          ...
          <p className="mx-auto mt-10 max-w-xl text-base leading-7 text-white/40 md:text-lg">
            {subText}
          </p>
      ...
      <section
        ref={videoSectionRef}
        className="relative flex h-screen w-full items-center justify-center overflow-hidden bg-[#09090b]"
      >
        <div
          ref={videoBoxRef}
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="rounded-full border border-white/20 bg-black/30 px-6 py-3 text-xs font-semibold uppercase tracking-[0.25em] text-white/80 backdrop-blur-xl">
      ...
      <section className="hero-bottom relative flex min-h-screen items-center justify-center overflow-hidden px-6 text-center">
        ...
        <div className="absolute inset-0">
          <div className="absolute left-1/2 top-1/2 h-[400px] w-[400px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#e3a008]/10 blur-[130px]" />
        </div>

        <div className="relative z-10 max-w-5xl">

          <p className="mb-6 text-sm font-semibold uppercase tracking-[0.3em] text-white/30">
            The future of restaurant queues
          </p>

          <h2 className="text-[clamp(3rem,8vw,8rem)] font-black leading-[0.9] tracking-[-0.06em]">
            {bottomText || (
              <>
                <span className="hero-bottom-word inline-block">
                  Less waiting.
                </span>
                <br />
                <span className="hero-bottom-word inline-block text-[#e3a008]">
                  More dining.
                </span>
              </>
            )}
          ...
          <p className="mx-auto mt-8 max-w-xl text-base leading-7 text-white/40 md:text-lg">
            Give your staff a simple way to manage the
            queue while your customers stay informed.
          </p>

          <div className="mt-10">
            <a
              href="/dashboard"
              className="inline-flex rounded-full bg-white px-8 py-4 text-sm font-bold text-black transition duration-300 hover:scale-105 hover:bg-white/90"
            >
              Launch DhabaQueue →
            </a>
          </div>
